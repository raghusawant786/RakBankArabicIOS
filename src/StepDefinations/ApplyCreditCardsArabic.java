...
public class ApplyCreditCardsArabic extends BaseClass {
	...
	public void preferred_language_saving_salaride_page() throws Throwable {
		if (Runner.status == true) {
			...
			try {
				...
				driver.findElement(
						By.xpath("//XCUIElementTypeOther[@name=\"Let's go button\" or @content-desc='لنبدأ button']"))
						.click();
	...
	public void otp_enter_saving_salaride_page() throws Throwable {
		...
		if (Runner.status == true) {
			...
			try {
				...
				driver.findElement(By.xpath("//XCUIElementTypeSecureTextField[@name=\"رمز التحقق field\"]"))
	...
	public void select_a_product_youd_prefer_saving_salaride_page() throws Throwable {
		if (Runner.status == true) {
			...
			try {
				...
				driver.findElement(By.id("اجمالي دخلك الشهري field"))
		...
		if (Runner.status == true) {
			...
			try {
				...
				if (CardsType.equals("Emirates Skywards World Elite Credit Card")) { //
					...
					wait.until(
							(Function) ExpectedConditions.presenceOfElementLocated(By.id("سكاي ووردز طيران الإمارات")));
					...
					sleep(4000);
					driver.findElement(By.xpath("(//XCUIElementTypeOther[@name=\"احصل على البطاقة button\"])[1]"))
							.click();
				...
				if (CardsType.equals("World Credit Card")) {
					...
					System.out.println("World Credit Card");
					sleep(4000);
					driver.findElement(By.xpath("(//XCUIElementTypeOther[@name=\"احصل على البطاقة button\"])[2]"))
							.click();
				...
				if (CardsType.equals("HighFlyer Platinum Credit Card")) {
					...
					wait.until((Function) ExpectedConditions
							.presenceOfElementLocated(By.id("بطاقة هاي فلاير الائتمانية")));
					...
					sleep(4000);
					driver.findElement(By.xpath("(//XCUIElementTypeOther[@name=\"احصل على البطاقة button\"])[3]"))
							.click();
				...
				if (CardsType.equals("Titanium Credit Card")) {
					...
					sleep(4000);
					driver.findElement(By.xpath("(//XCUIElementTypeOther[@name=\"احصل على البطاقة button\"])[4]"))
							.click();
				...
				if (CardsType.equals("RED Credit Card")) {
					...
					sleep(4000);
					driver.findElement(By.xpath("(//XCUIElementTypeOther[@name=\"احصل على البطاقة button\"])[5]"))
							.click();
				...
				if (CardsType.equals("RAKislamic Emirates Skywards World Elite Credit Card")) {
					...
					wait.until((Function) ExpectedConditions.presenceOfElementLocated(
							By.id("بطاقة راك الإسلامي سكاي واردز طيران الإمارات وورلد إيليت")));
					...
					System.out.println("Emirates Skywards World Elite Credit Card");
					sleep(4000);
					driver.findElement(By.xpath("(//XCUIElementTypeOther[@name=\"احصل على البطاقة button\"])[6]"))
							.click();
					System.out.println("Emirates Skywards World Elite Credit Card clicked");
				}
				...
				if (CardsType.equals("RAKislamic World Credit Card")) {
					...
					wait.until((Function) ExpectedConditions
							.presenceOfElementLocated(By.id("بطاقة مرابحة وورلد الإئتمانية")));
					...
					sleep(4000);
					driver.findElement(By.xpath("(//XCUIElementTypeOther[@name=\"احصل على البطاقة button\"])[7]"))
							.click();
				...
				if (CardsType.equals("RAKislamic Platinum Credit Card")) {
					...
					wait.until((Function) ExpectedConditions
							.presenceOfElementLocated(By.id("بطاقة المرابحة بلاتينوم الإئتمانية")));
					...
					sleep(4000);
					driver.findElement(By.xpath("(//XCUIElementTypeOther[@name=\"احصل على البطاقة button\"])[8]"))
							.click();
	...
	public void account_option_saving_salaride_page() throws Throwable {
		...
		if (Runner.status == true) {
			...
			try {
				...
				wait.until((Function) ExpectedConditions
						.presenceOfElementLocated(By.id("تصفح الوثيقة جيداً ثم قم بالموافقة")));
				driver.findElement(By.id("تصفح الوثيقة جيداً ثم قم بالموافقة")).click();

				wait.until((Function) ExpectedConditions
						.presenceOfElementLocated(By.xpath("//XCUIElementTypeOther[@name='لنواصل button']")));
	...
	public void pdf_saving_salaride_page() throws Throwable {
		...
		if (Runner.status == true) {
			...
			try {
				...
				// Address")));
				driver.findElement(By.id("البريد الإلكتروني"))
		...
		if (Runner.status == true) {
			...
			try {
				...
				if (AreYouPoliticallyExposedPerson.equals("Yes")) {
					...
					driver.findElement(By.id("منصبك السابق field"))
			...
			try {
				...
				if (AreYouPoliticallyExposedPerson.equals("Yes")) {
					...
					if (YouareaPEPby.equals("Association radio")) {
						...
						wait.until((Function) ExpectedConditions
								.presenceOfElementLocated(By.id("اسم الشخصية السياسية field")));
						driver.findElement(By.id("اسم الشخصية السياسية field"))
								.sendKeys(new CharSequence[] { NameOfThePEP + Keys.ENTER });

						wait.until((Function) ExpectedConditions
								.presenceOfElementLocated(By.id("دولة إقامة الشخصية السياسية value")));
	...
	public void your_residential_address_saving_salaride_page() throws Throwable {
		...
		if (Runner.status == true) {
			...
			try {
				...
				WebDriverWait wait = new WebDriverWait(driver, 30);
				wait.until((Function) ExpectedConditions.presenceOfElementLocated(
						By.xpath("(//XCUIElementTypeOther[@name=\"هذا ما يجب عليك معرفته\"])[2]")));
				...
				wait.until((Function) ExpectedConditions.presenceOfElementLocated(
						By.xpath("//XCUIElementTypeOther[@name=\"أوافق على ما ورد ذكره button\"]")));
				driver.findElement(By.xpath("//XCUIElementTypeOther[@name=\"أوافق على ما ورد ذكره button\"]")).click();

				wait.until((Function) ExpectedConditions
						.presenceOfElementLocated(By.xpath("//XCUIElementTypeStaticText[@name=\"لنواصل\"]")));
		...
		if (Runner.status == true) {
			...
			try {
				...
				if (ProveYourIncome.equals("FTSCheck")) {
					...
					wait.until((Function) ExpectedConditions.presenceOfElementLocated(By.xpath(
							"(//XCUIElementTypeOther[@name='موافقة فورية، حال توافق الشروط'])[2]/XCUIElementTypeOther")));
					driver.findElement(By.xpath(
							"(//XCUIElementTypeOther[@name='موافقة فورية، حال توافق الشروط'])[2]/XCUIElementTypeOther"))
							.click();
				...
				try {
					...
					if (ProveYourIncome.equals("BankStatements")) {
						...
						new WebDriverWait((WebDriver) driver, 60L).until((Function) ExpectedConditions
								.elementToBeClickable(MobileBy.AccessibilityId("تحميل button")));
						((MobileElement) driver.findElement(MobileBy.AccessibilityId("تحميل button"))).click();

						new WebDriverWait((WebDriver) driver, 60L).until((Function) ExpectedConditions
								.elementToBeClickable(MobileBy.AccessibilityId("أضف ملف button")));
						...
						new WebDriverWait((WebDriver) driver, 60L).until((Function) ExpectedConditions
								.elementToBeClickable(MobileBy.AccessibilityId("تقديم button")));
						((MobileElement) driver.findElement(MobileBy.AccessibilityId("تقديم button"))).click();

						sleep(60000);

						new WebDriverWait((WebDriver) driver, 90L).until(
								(Function) ExpectedConditions.elementToBeClickable(MobileBy.AccessibilityId("استمر")));
	...
	public void second_company_details_saving_salaride_page() throws Throwable {
		if (Runner.status == true) {
			...
			try {
				...
				driver.findElement(By.id("الاسم على البطاقة field"))
	...
	public void third_company_details_saving_salaride_page() throws Throwable {
		if (Runner.status == true) {
			...
			try {
				wait.until((Function) ExpectedConditions
						.presenceOfElementLocated(By.xpath("(//XCUIElementTypeOther[@name=\"أرغب في التسجيل\"])[2]")));
	...
	public void fourth_company_details_saving_salaride_page() throws Throwable {
		if (Runner.status == true) {
			...
			try {
				...
				wait.until((Function) ExpectedConditions.presenceOfElementLocated(
						By.xpath("(//XCUIElementTypeOther[@name=\"الاطلاع والموافقة\"])[1]")));
				driver.findElement(By.xpath("(//XCUIElementTypeOther[@name=\"الاطلاع والموافقة\"])[1]")).click();

				wait.until((Function) ExpectedConditions
						.presenceOfElementLocated(By.id("أوافق على ما تم ذكره في الوثيقة")));
				for (int i = 0; i <= 4; i++) {
		...
		if (Runner.status == true) {
			...
			try {
				...
				try {
					...
					wait.until((Function) ExpectedConditions
							.presenceOfElementLocated(By.id("إذا كنت عضواً في سكاي ووردز طيران الإمارات field")));
					driver.findElement(By.id("إذا كنت عضواً في سكاي ووردز طيران الإمارات field"))
...
// field removed	String POBox = getColumnNumber(Spath,"POBox",sTestCaseid);
			...
			try {
				...
				((MobileElement) driver.findElement(MobileBy.AccessibilityId("المنطقة / القُطر field")))
						.sendKeys(new CharSequence[] { StreetLocation + Keys.ENTER });
				((MobileElement) driver.findElement(MobileBy.AccessibilityId("نقطة الإستدلال field")))
						.sendKeys(new CharSequence[] { StreetLocation + Keys.ENTER });
// field removed		        ((MobileElement)driver.findElement(MobileBy.AccessibilityId("PO Box field"))).sendKeys(new CharSequence[] { POBox + Keys.ENTER });
				...
				driver.findElement(By.id("رقم هاتف المنزل field"))
				...
				driver.findElement(By.id("المدينة / البلدة field"))
				...
				BaseClass.swipe("up", "لنواصل button");
				new WebDriverWait((WebDriver) driver, 60L).until(
						(Function) ExpectedConditions.elementToBeClickable(MobileBy.AccessibilityId("لنواصل button")));
				((MobileElement) driver.findElement(MobileBy.AccessibilityId("لنواصل button"))).click();
				...
				if (PayTaxInUAE.equals("Yes")) {
					...
					((WebElement) (new WebDriverWait((WebDriver) driver, 90L))
							.until((Function) ExpectedConditions.presenceOfElementLocated(MobileBy.xpath(
									"(//XCUIElementTypeOther[@name=\"الدول التي قمت بتسديد الضرائب بها خلال العام الماضي\"])[1]"))))
							.isDisplayed();
					...
					((WebElement) new WebDriverWait((WebDriver) driver, 90L)
							.until((Function) ExpectedConditions.presenceOfElementLocated(
									MobileBy.AccessibilityId("رقم التعريف الضريبي (إذا كان معروفاً) field"))))
							.isDisplayed();

					((MobileElement) driver
							.findElement(MobileBy.AccessibilityId("رقم التعريف الضريبي (إذا كان معروفاً) field")))
		...
		if (Runner.status == true) {
			...
			try {
				...
				if (AdvicesCommunication.equals("Yes")) {
					...
					((MobileElement) driver.findElement(
							MobileBy.xpath("(//XCUIElementTypeOther[@name=\"لا، أُفضّل البريد radio\"])[2]"))).click();
				...
				((MobileElement) driver.findElement(MobileBy.xpath("//XCUIElementTypeStaticText[@name=\"لنواصل\"]")))
						.click();
	...
	public void Create_Login_Details_Page() throws Throwable {
		...
		if (Runner.status == true) {
			...
			try {
				...
				((MobileElement) driver.findElement(MobileBy.AccessibilityId("اسم المستخدم field")))
				...
				sleep(5000);
				((MobileElement) driver.findElement(MobileBy.AccessibilityId("كلمة السر field")))
						.sendKeys(new CharSequence[] { Password + Keys.ENTER });

				// WirtePassword(Password);
				((MobileElement) driver.findElement(MobileBy.AccessibilityId("تأكيد كلمة المرور field")))
						.sendKeys(new CharSequence[] { Password + Keys.ENTER });
